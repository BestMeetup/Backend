...
public class ApiInvoker {
  ...
  */
  ...
  public static void initializeInstance(Cache cache, Network network, int threadPoolSize, ResponseDelivery delivery, int connectionTimeout) {
     ...
     INSTANCE.authentications.put("api_client", new ApiKeyAuth("header", "client"));
     INSTANCE.authentications.put("api_key", new ApiKeyAuth("header", "access-token"));
     INSTANCE.authentications.put("api_uid", new ApiKeyAuth("header", "uid"));
