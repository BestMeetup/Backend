...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/DeviseResponseError', 'model/DeviseResponseUser', 'model/User'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('../model/DeviseResponseError'), require('../model/DeviseResponseUser'), require('../model/User'));
  } else {
    // Browser globals (root is window)
    if (!root.SwaggerBestMeetup) {
      root.SwaggerBestMeetup = {};
    }
    root.SwaggerBestMeetup.UsuarioApi = factory(root.SwaggerBestMeetup.ApiClient, root.SwaggerBestMeetup.DeviseResponseError, root.SwaggerBestMeetup.DeviseResponseUser, root.SwaggerBestMeetup.User);
  }
}(this, function(ApiClient, DeviseResponseError, DeviseResponseUser, User) {
  'use strict';
